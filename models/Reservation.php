...
class Reservation
{
    ...
    {
        $stmt = $this->pdo->prepare("SELECT COUNT(*) FROM reservations WHERE conducteur_id = ?");
    ...
    {
        $stmt = $this->pdo->prepare("SELECT COUNT(*) FROM reservations WHERE conducteur_id = ? AND statut = ?");
